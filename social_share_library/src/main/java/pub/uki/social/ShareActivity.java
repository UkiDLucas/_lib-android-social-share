            ...
            public void onClick(View v) {
                ...
                if (isTwitter) {
                    ...
                    if (intent.hasExtra(Extras.EXTRA_SHARE_MESSAGE)) {
                        String extraMsg = intent.getSerializableExtra(Extras.EXTRA_SHARE_MESSAGE).toString();
                        pub.uki.social.util.ShareMessage msg = new ShareMessage(extraMsg);
                        new SNServices(mAppName).updateFacebookStatus(msg, edittext.getText().toString(), ShareActivity.this);
                    } else {
